class Get::GetController < ActionController::Base
  ...
  rescue_from Exception, :with => :handle_exception
  	...
  	def show
		...
		@app_store = 'https://itunes.apple.com/us/app/PicLib/id1040170648?mt=8'
		@play_store = 'https://play.google.com/store/apps/details?id=com.PicLib.android'
